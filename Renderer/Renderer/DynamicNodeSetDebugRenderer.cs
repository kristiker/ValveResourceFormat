...
namespace ValveResourceFormat.Renderer
{
    ...
    /// </summary>
    public class DynamicNodeSetDebugRenderer : LineDebugRenderer
    {
        private readonly DynamicNodeSet nodeSet;
        ...
        public DynamicNodeSetDebugRenderer(DynamicNodeSet nodeSet, RendererContext rendererContext)
            : base(rendererContext, nameof(DynamicNodeSetDebugRenderer))
        {
