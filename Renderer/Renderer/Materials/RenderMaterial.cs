...
{
    /// <summary>Names the sampler uniforms bound to a <see cref="ReservedTextureSlots"/> member. Names may share a slot when they never coexist in one shader variant.</summary>
