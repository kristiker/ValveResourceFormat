    ...
    public class PhysicsTraceDebugRenderer
    {
        ...
        private void Rebuild(Rubikon physics, UserInput input, Camera camera)
        {
            ...
            if (!input.NoClip)
            {
                ...
                // Green when grounded, yellow in air
                var hullColor = movement.OnGround ? new Color32(0f, 1f, 0f, 1f) : new Color32(1f, 1f, 0f, 1f);
            ...
            var trace = physics.TraceAABB(from, to, CameraTraceHalfExtents, "player");
