...
namespace ValveResourceFormat.Renderer.World
{
    ...
    public class WorldLightingInfo(Scene scene)
    {
        ...
        {
            // Probe volumes share the lightmap units; a draw is either lightmapped or probe lit, never both.
            Debug.Assert(!(HasValidLightmaps && HasValidLightProbes),
                "Scene has both lightmaps and light probes; they share reserved texture units and cannot both be bound.");
