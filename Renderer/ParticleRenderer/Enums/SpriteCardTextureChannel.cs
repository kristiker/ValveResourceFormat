namespace ValveResourceFormat.Renderer.Particles
{
    ...
    /// </summary>
    /// <remarks>
    /// These are binary operators over (accumulator, layer), not plain swizzles: the "mask" and
    /// "*_RGBALPHA" modes take their other operand from the accumulator, which starts at white. With a
    /// single layer that accumulator folds away and most modes read as a swizzle of the sample, which
    /// is why they are named as though they were. The modes below describe the general form; A is the
    /// accumulator and B the layer.
    /// </remarks>
