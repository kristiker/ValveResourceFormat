namespace ValveResourceFormat.Renderer.Particles
{
    ...
    /// </summary>
    /// <remarks>
    /// The first five values line up with the effect switch in the spritecard pixel shader, in order.
    /// The last two fall past it, which is why that switch leaves them as an unmodified sample.
    /// </remarks>
